...
[<EntryPoint>]
let main argv =
    let world = group [ sphere (vec3 0.0f 0.0f -1.0f) 0.5f (metal (vec3 0.8f 0.6f 0.4f) 0.3f rng); sphere (vec3 0.0f -100.5f -1.0f) 100.0f (lambertian (vec3 0.5f 0.6f 0.3f) rng) ]
